...
fn Blog(id: i32) -> Element {
    rsx! {
        ...
        div {
            ...
            h1 { class: "text-3xl font-bold mb-4 p-4","Blog post {id}" }
        }
    }
}
...
fn Home() -> Element {
    ...
    rsx! {
        ...
        div {
            class: "flex flex-col items-center justify-center h-screen",
            h1 { class: "text-3xl font-bold mb-4 p-4","High-Five counter: {count}" }
            button {
...
fn NotFound() -> Element {
    rsx!(
        div {
            class: "flex flex-col items-center justify-center h-screen",
            h1 { class: "text-3xl font-bold mb-4 p-4", "404 Not Found" }
        }
    )
}
